...
<script type="text/javascript" src="js/My97DatePicker/WdatePicker.js" charset="gb2312"></script>
        <script language="javascript">
           ...
           function yundanjiluDetail(id)
           {
                  // window.location.href="yundanjiluDetail.action?id="+id;
				   window.open("yundanjiluDetail.action?id="+id,"_blank");
           }
           ...
           function go(index)
           {
               ...
               document.form123.action="yundanjiluList2.action"
	...
	<form action="yundanjiluList.action" name="formAdd" method="post">
			...
			<table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom:8px">
			 ...
			 <%
			String sql="select * from t_yundanjilu where wangdianbianhao='"+(String)request.getSession().getAttribute("username")+"'  ";
