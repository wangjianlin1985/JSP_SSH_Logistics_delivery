...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="shoucangjiluAdd.action" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#CCCCCC" style="border-collapse:collapse">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" >添加收藏记录<input name="addtime" type="hidden" id="addtime" value="<%=connDbBean.gettime()%>" /></td>
						</tr>
						...
						<script language="javascript">document.form1.username.value='<%=request.getSession().getAttribute("username")%>';document.form1.username.setAttribute("readOnly",'true');</script>						
					 </table>
			</form>
   </body>
</html>
