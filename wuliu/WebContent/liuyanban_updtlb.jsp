...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<tr style='display:none'><td width="200">头像：</td><td><input name='xingbie' type='text' id='xingbie' value='' onblur='checkform()' style='border:solid 1px #000000; color:#666666' />&nbsp;*<label id='clabelxingbie' /></td></tr>
...
<script language=javascript >  
 ...
 function checkform(){  
	...
	var xingbieobj = document.getElementById("xingbie"); if(xingbieobj.value==""){document.getElementById("clabelxingbie").innerHTML="&nbsp;&nbsp;<font color=red>请输入头像</font>";return false;}else{document.getElementById("clabelxingbie").innerHTML="  "; } 
